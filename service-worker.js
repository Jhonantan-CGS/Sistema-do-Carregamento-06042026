const CACHE_NAME = 'cysy-log360-v20260409r02';
const CACHE_TTL_MS = 12 * 60 * 60 * 1000;
const PWA_START_URL = './app-shell.html?source=pwa';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?v=20260409r02',
  './launch.html',
  './launch.html?v=20260409r02',
  './app-shell.html',
  './app-shell.html?v=20260409r02',
  PWA_START_URL,
  './offline.html',
  './manifest.webmanifest',
  './manifest.webmanifest?v=20260409r02',
  './assets/css/modern.css',
  './assets/css/modern.css?v=20260409r02',
  './assets/css/theme-3d.css',
  './assets/css/theme-3d.css?v=20260409r02',
  './assets/logo.svg',
  './assets/icons/favicon.png',
  './assets/icons/favicon.png?v=20260409r02',
  './assets/icons/apple-touch-icon.png',
  './assets/icons/apple-touch-icon.png?v=20260409r02',
  './assets/icons/icon-192.png',
  './assets/icons/icon-192.png?v=20260409r02',
  './assets/icons/icon-512.png',
  './assets/icons/icon-512.png?v=20260409r02',
  './assets/icons/icon-512-maskable.png',
  './assets/icons/icon-512-maskable.png?v=20260409r02',
  './assets/js/app-core-1.js',
  './assets/js/app-core-1.js?v=20260409r02',
  './assets/js/app-core-2.js',
  './assets/js/app-core-2.js?v=20260409r02',
  './assets/js/app-core-3.js',
  './assets/js/app-core-3.js?v=20260409r02',
  './assets/js/app-core-5.js',
  './assets/js/app-core-5.js?v=20260409r02',
  './assets/js/app-core-6.js',
  './assets/js/app-core-6.js?v=20260409r02'
];
  ...
  try {
    ...
    if (isNavigation) {
      return cached || await caches.match(PWA_START_URL) ||
        await caches.match('./app-shell.html?v=20260409r02') ||
        await caches.match('./app-shell.html') ||
        await caches.match('./launch.html?v=20260409r02') ||
        await caches.match('./launch.html') ||
        await caches.match('./index.html?v=20260409r02') ||
